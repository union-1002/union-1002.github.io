      ...
      <div className="w-full flex flex-col items-center px-4 py-12 space-y-12">
        ...
        <div className="w-full max-w-3xl text-left space-y-2">
          ...
          <p className="text-base text-gray-700 leading-relaxed">
            ...
            모든 컨텐츠는 원작자의 감수를 받은 뒤에 업로드되는 오피셜 정보입니다.<br/>
            원작자는 이 사이트 운영에 관여하지 않습니다.<br/>
            회원가입 문의, 오류 제보, 기능 아이디어 제안 등 모든 문의는 공홈지기에게 전달해주세요!<br/><br/>

            광고비는 서버 비용으로 사용되며, 원작자에게 분배됩니다.<br/><br/>            
