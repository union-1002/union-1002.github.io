...
function MonthPage() {
  ...
  const defaultPosts = [
    ...
    },
    {
      id: 7,
      author: "L",
      text: "이달의 우수 사원이 삼촌이라고요? 너무너무 멋있어요🥹  삼촌 짱",
      replies: [
        { id: 11, author: "Y", text: "ㄱㅇㅇ" },
      ],
    },
    {
      id: 7,
  ...
  const grimmerReaperPosts = [
    ...
    },
    {
      id: 7,
      author: "L",
      text: "근데... 여기서... 이러시면... 안돼요.......",
      replies: [
        { id: 11, author: "느베야", text: "눈치 챙겨" },
        { id: 11, author: "L", text: "나가라구..." },
        { id: 11, author: "느베야", text: "응 안들리죠?ㅋㅋ" },
      ],
    },
  ];
